...
const answers = [
  ['Coffee', 'Noodles', 'Hiking, subnote from Jim: Shes been on her hiking grinddd the last few months', 'Big City', 'Never find a satisfying hike again, subnote from Jim: WOW what a question...a tough one for sure'],
  ...
  ['Mapo Tofu or any messy foods aka wings or ribs', 'White Linen from Proud Mary in South Africe; if that's not available then a refreshing Gin cocktail', 'Chicken Ruby', 'Good: Dishoom, Thanksgiving buffet Korea, Shake Shack in Seoul, Bad: the one true answer is Garlic Scallion Noodles that Jim made, Most memorable for embarrassing reasons: Breakfast pufferfish experience in Busan', 'Jim, subnote from Jim: Lauren appreciates food more, Jim enjoys it more based on quantity']
];
